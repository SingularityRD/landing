const REGIONS = {
  ...
  description:
    "Looking for Singularity in a different cloud provider or region? Select your preference below, and we'll notify you as soon as it's available.",
  ...
  options: [
    ...
    { id: 'asia-northeast1', name: 'GCP - Japan (Tokyo)' },
    { id: 'asia-northeast2', name: 'GCP - Japan (Osaka)' },
    { id: 'asia-northeast3', name: 'GCP - South Korea' },
    { id: 'asia-south1', name: 'GCP - India (Mumbai)' },
    { id: 'asia-south2', name: 'GCP - India (Delhi)' },
    { id: 'asia-southeast1', name: 'GCP - Singapore' },
    { id: 'asia-southeast2', name: 'GCP - Indonesia' },
    { id: 'australia-southeast1', name: 'GCP - Australia (Sydney)' },
    { id: 'australia-southeast2', name: 'GCP - Australia (Melbourne)' },
    { id: 'europe-central2', name: 'GCP - Poland' },
    { id: 'europe-north1', name: 'GCP - Finland' },
    { id: 'europe-southwest1', name: 'GCP - Spain' },
    { id: 'europe-west1', name: 'GCP - Belgium' },
    { id: 'europe-west2', name: 'GCP - United Kingdom' },
    { id: 'europe-west3', name: 'GCP - Germany (Frankfurt)' },
    { id: 'europe-west4', name: 'GCP - Netherlands' },
    { id: 'europe-west6', name: 'GCP - Switzerland (Zurich)' },
    { id: 'europe-west8', name: 'GCP - Italy (Milan)' },
    { id: 'europe-west9', name: 'GCP - France (Paris)' },
    { id: 'europe-west12', name: 'GCP - Italy (Turin)' },
    { id: 'me-central1', name: 'GCP - Qatar' },
    { id: 'me-west1', name: 'GCP - Israel' },
    { id: 'northamerica-northeast1', name: 'GCP - Canada (Montréal)' },
    { id: 'northamerica-northeast2', name: 'GCP - Canada (Toronto)' },
    { id: 'southamerica-east1', name: 'GCP - Brazil' },
    { id: 'southamerica-east2', name: 'GCP - Chile' },
    { id: 'us-central1', name: 'GCP - USA (Iowa)' },
    { id: 'us-east1', name: 'GCP - USA (South Carolina)' },
    { id: 'us-east4', name: 'GCP - USA (Northern Virginia)' },
    { id: 'us-east5', name: 'GCP - USA (Ohio)' },
    { id: 'us-south1', name: 'GCP - USA (Texas)' },
    { id: 'us-west1', name: 'GCP - USA (Oregon)' },
    { id: 'us-west2', name: 'GCP - USA (California)' },
    { id: 'us-west3', name: 'GCP - USA (Utah)' },
    { id: 'us-west4', name: 'GCP - USA (Nevada)' },
  ],
...
const EXTENSIONS = {
  ...
  description: 'Looking for a specific integration? Suggest one using this form.',

  ...
  <section className="hero safe-paddings pt-[194px] xl:pt-[154px] lg:pt-[46px] md:pt-[34px]">
    ...
    >
      ...
      <div className="max-w-sm pt-3 text-lg leading-snug tracking-extra-tight text-gray-new-50 xl:max-w-[352px] xl:pt-1.5 lg:max-w-[288px] lg:pt-1 lg:text-base md:mt-8 md:max-w-none md:pt-0">
        <p>
          <span className="text-white">We are hackers.</span> ICS/OT researchers. Satellite security experts.
          We've spent 4 years on AI security research—before it was called that.
        </p>
        <p className="mt-6">
          We developed the <span className="text-white">highest-performing security SLM in literature</span>,
          outperforming Cisco and Trend Micro on attack detection benchmarks.
          <span className="text-white"> Bootstrapped. No investors.</span> Just results.
        </p>
      </div>
    </Container>
  </section>

  ...
  <section className="multitenancy safe-paddings mt-8 overflow-hidden xl:-mt-9 lg:-mt-7 md:-mt-2 sm:mt-0">
    ...
    */}
    ...
    <Container
      ...
      size="960"
    >
      <div className="max-w-[608px] text-xl leading-snug tracking-extra-tight text-gray-new-50 xl:max-w-xl xl:text-lg lg:max-w-[480px] lg:text-base space-y-4">
        <p>
          <strong className="text-white">REPS</strong> — Mastery through repetition. 50,000+ challenges in algorithms, security, and ML.
        </p>
        <p>
          <strong className="text-white">Brief</strong> — Where Turkey's tech gets its news. Original reporting. The stories that move markets.
        </p>
        <p>
          <strong className="text-white">IAM</strong> — Zero-trust identity. Every login logged. Every permission earned.
        </p>
      </div>
    </Container>
  </section>

...
import elephantImage from 'images/pages/home/trusted/elephant.png';
    ...
    <Container className="xl:max-w-[864px]" size="1152">
      ...
      >
        ...
        <Card
          ...
          bgImage={digitImage}
        >
          <strong className="font-medium text-white">14 Days.</strong>{' '}
          <span className="font-light">SOC 2 certified. Not months. Days.</span>
        </Card>
        <Card
          className={clsx(
        ...
        >
          <strong className="font-medium text-white">99.997% Prevention.</strong> Zero false
          positives. Zero breaches. Zero exceptions.
        </Card>
        <Card
        ...
        >
          <span className="flex items-end font-medium text-white transition-colors duration-200 group-hover:text-green-45">
            <span>50M+ Fraud Attempts Blocked</span>

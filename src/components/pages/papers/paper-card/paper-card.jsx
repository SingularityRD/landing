...
const PaperCard = ({ paper }) => {
  ...
  const linkUrl = paper.type === 'external' ? paper.externalUrl : '#';
  ...
  return (
    <>
        ...
        <div className="flex flex-1 flex-col p-6">
          ...
          <div className="flex flex-wrap items-center gap-3 border-t border-gray-new-15 pt-5">
            {paper.type === 'pdf' && paper.pdfUrl && (
              <Link
                to={paper.pdfUrl}
                className="inline-flex items-center gap-2 rounded-lg bg-white px-4 py-2.5 text-sm font-semibold text-black transition-all hover:bg-green-45 hover:shadow-lg hover:shadow-green-45/25"
              >
            ...
            {paper.type === 'external' && paper.externalUrl && (
              <Link
                ...
                isExternal
                className="inline-flex items-center gap-2 rounded-lg bg-blue-500 px-4 py-2.5 text-sm font-semibold text-white transition-all hover:bg-blue-400 hover:shadow-lg hover:shadow-blue-500/25"
              >
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-lg border border-gray-new-20 bg-gray-new-8 px-4 py-2.5 text-sm font-medium text-gray-new-40 transition-all hover:border-gray-new-40 hover:text-white"
            >
      ...
      {showCitation && (
        ...
        >
          <div 
            className="relative w-full max-w-2xl overflow-hidden rounded-2xl border border-gray-new-15 bg-gray-new-8 shadow-2xl"
          ...
          >
            ...
            <div className="flex items-center justify-between border-b border-gray-new-15 bg-gray-new-10 px-6 py-4">
              ...
              <button
                onClick={() => setShowCitation(false)}
                className="flex h-8 w-8 items-center justify-center rounded-full bg-gray-new-15 text-gray-new-50 transition-colors hover:bg-gray-new-20 hover:text-white"
              >
              ...
              <div className="mb-6">
                <div className="mb-3 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 rounded-lg bg-gray-new-15 px-3 py-1.5 text-xs font-medium text-white transition-all hover:bg-green-45 hover:text-black"
                  >
                    {copiedFormat === 'apa' ? (
                      <>
                ...
                <div className="rounded-lg border border-gray-new-15 bg-black p-4">
                  <code className="block whitespace-pre-wrap break-all text-sm leading-relaxed text-gray-new-50">
                    {paper.citations.apa}
                  </code>
                </div>
              </div>

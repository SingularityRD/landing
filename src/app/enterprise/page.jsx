...
import HowSingularityHelps from 'components/pages/enterprise/how-neon-helps';
...
const caseStudies = [
  {
    ...
    link: `${LINKS.blog}/enterprise-case-study-retool`,
  },
  {
    title: '5x faster',
    ...
    link: `${LINKS.blog}/enterprise-case-study-mindvalley`,
  },
  {
  ...
  },
  {
    ...
    link: `${LINKS.blog}/enterprise-case-study-wordware`,
  },
  {
    title: '80% savings',
    ...
    link: `${LINKS.blog}/enterprise-case-study-invenco`,
  },
  {
    ...
    link: `${LINKS.blog}/enterprise-case-study-dispatch`,
  },
];

const howSingularityHelpsTabs = [
  {
...
const bentoCards = [
  {
    ...
    description:
      'Singularity enables instant security environment provisioning, allowing your team to start protecting right away.',
    image: instantDb,
    imageMd: instantDbMd,
  ...
  },
  {
    ...
    description: 'Integrate Singularity into your security platform or AI Agent via API.',
    image: integration,
...
const faqItems = [
  ...
  },
  {
    ...
    answer: `Singularity offers a 99.95% uptime SLA for enterprise customers, ensuring consistent availability and performance for mission-critical applications. <a href="/enterprise-sla">Read more.</a>`,
  },
  {
...
const EnterprisePage = () => (
  <Layout headerClassName="!absolute !bg-transparent">
    ...
    <HowSingularityHelps tabs={howSingularityHelpsTabs} />
    <TestimonialNew
